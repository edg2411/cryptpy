...
def on_message(client, userdata, message):
    # print("Message received: "  + message.payload) # por alguna razon no funciona!!!!
    # print(message.topic+" "+str(message.payload)) # con formato byte string
    print(message.topic+"\t{}".format(message.payload.decode("utf-8"))) # ok
